...
import casefan from '../assets/45253.jpg'
...
const Login = () => {
    ...
    return (
        <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
            <div className="hidden bg-contain lg:block lg:w-1/2" style={{
                backgroundImage: `url(${casefan})`,
            }}></div>
            ...
            <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
                ...
                <a onClick={handleGoogle} href="#" className="flex items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <div className="flex items-center justify-between mt-4">
                    ...
                    <a href="#" className="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline"><Link to={'/register'}>Sign UP</Link></a>
